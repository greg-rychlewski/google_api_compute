...
defmodule GoogleApi.Compute.V1.Model.HttpsHealthCheckLegacy do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.HttpsHealthCheckLegacy do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.HttpsHealthCheckLegacy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.HttpsHealthCheckLegacy do

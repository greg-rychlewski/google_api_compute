...
defmodule GoogleApi.Compute.V1.Model.HttpHealthCheckLegacy do
  @moduledoc """
...
defimpl Poison.Decoder, for: GoogleApi.Compute.V1.Model.HttpHealthCheckLegacy do
  def decode(value, options) do
    GoogleApi.Compute.V1.Model.HttpHealthCheckLegacy.decode(value, options)
  end
end

defimpl Poison.Encoder, for: GoogleApi.Compute.V1.Model.HttpHealthCheckLegacy do
